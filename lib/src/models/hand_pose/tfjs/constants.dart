...
const DEFAULT_MPHANDS_MODEL_CONFIG = MediaPipeHandsTfjsModelConfig(
  modelType: MediaPipeHandsModelType.full,
  maxHands: 2,
  detectorModelUrl: DEFAULT_MPHANDS_DETECTOR_MODEL_URL_FULL,
  landmarkModelUrl: DEFAULT_MPHANDS_LANDMARK_MODEL_URL_FULL,
);

const DEFAULT_MPHANDS_ESTIMATION_CONFIG = MediaPipeHandsTfjsEstimationConfig(
  flipHorizontal: false,
  staticImageMode: false,
);

const MPHANDS_TENSORS_TO_DETECTION_CONFIGURATION = TensorsToDetectionsConfig(
...
const MPHANDS_LANDMARK_RECT_TRANSFORMATION_CONFIG = RectTransformationConfig(
    shiftX: 0, shiftY: -0.1, scaleX: 2.0, scaleY: 2.0, squareLong: true);
const MPHANDS_DETECTOR_IMAGE_TO_TENSOR_CONFIG = ImageToTensorConfig(
...
const MPHANDS_LANDMARK_IMAGE_TO_TENSOR_CONFIG = ImageToTensorConfig(
  outputTensorSize: InputResolution(width: 224, height: 224),
  keepAspectRatio: true,
  outputTensorFloatRange: [0, 1],
  borderMode: BorderMode.zero,
);

const MPHANDS_HAND_PRESENCE_SCORE = 0.5;
const MPHANDS_MIN_SIMILARITY_THRESHOLD = 0.5;
const MPHANDS_TENSORS_TO_LANDMARKS_CONFIG = TensorsToLandmarksConfig(
  numLandmarks: 21,
  inputImageWidth: 224,
...
const MPHANDS_TENSORS_TO_WORLD_LANDMARKS_CONFIG = TensorsToLandmarksConfig(
  numLandmarks: 21,
  inputImageWidth: 1,
  inputImageHeight: 1,
  visibilityActivation: 'none',
